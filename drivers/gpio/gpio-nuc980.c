...
static const struct gpio_port *nuc980_gpio_cla_port(unsigned int gpio_num,
...
static int nuc980_gpio_core_get(struct gpio_chip *gc, unsigned int gpio_num)
{
	int port_num,group_num;
	const struct gpio_port *port;
	ENTRY();
...
static void nuc980_gpio_core_set(struct gpio_chip *gc, unsigned int gpio_num,
                                 int val)
{
	int port_num,group_num;
	const struct gpio_port *port;
...
static int nuc980_gpio_core_to_request(struct gpio_chip *chip, unsigned int offset)
{
...
static void nuc980_gpio_core_to_free(struct gpio_chip *chip, unsigned int offset)
{
	ENTRY();
}
